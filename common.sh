...
PATH=/Volumes/Miscellaneous/tmp/opt/gcc-9.1.0/bin:$PATH
TOP=/Volumes/Miscellaneous
PREFIX=$TOP/arm/gcc-9.1.0
BUILD=x86_64-apple-darwin15

SRC_PATH=$TOP/tmp
BINUTILS_PATH=$SRC_PATH/binutils-2.32
GCC_PATH=$SRC_PATH/gcc-9.1.0
NEWLIB_PATH=$SRC_PATH/newlib-3.1.0
